  ...
  return (
    <TooltipProvider delayDuration={250}>
      <header className="sticky top-0 z-50 border-b border-white/[0.09] bg-[#0b1012]/98">
        <div className="flex h-[86px] items-center justify-between px-5 sm:px-8 lg:h-[96px] lg:px-[34px]">
          <SoilIndexWordmark />
              ...
              <SheetContent>
                ...
                <div className="mt-8 grid grid-cols-2 border-y border-white/10 py-4">
                  ...
                  <div className="border-l border-white/10 pl-5">
                    <div className="flex items-center gap-2 text-xl font-light text-[#9ccb68]">
                      <span className="size-2 rounded-full bg-[#8cbf60]" /> Demo
                    </div>
                    <div className="mt-1 text-[9px] font-semibold uppercase text-white/34">
                      Data status
                    </div>
